...
class MCITGAN(BaseSynthesizer):
    def __init__(self, embedding_dim=100,
                 ...
                 batch_size=2000, discriminator_steps=1, generator_steps=1,
                 log_frequency=True, verbose=False, epochs=300, pac=1,
                 eta=1, alpha=0.6, beta=0.4, gamma=0.6, cuda=True):
        ...
        for i in range(epochs):
            for id_ in range(steps_per_epoch):
                ...
                for n_d in range(self._discriminator_steps):
                    ...
                    pen = self._discriminator.calc_gradient_penalty(real_cat_d, fake_cat_d, self._device, self.pac)
                ...
                for n_g in range(self._generator_steps):
                    ...
                    loss_class_g = classifier_loss(classifier_output_g.detach(), fake_target.detach())
                    ...
                    loss_g = self._eta*loss_adv + self._alpha*loss_cond +\
                             self._beta*loss_cluster + self._gamma*loss_class_g
